  ...
  const handleProsesLaporan = async (laporanId) => {
    try {
      ...
      const updateResponse = await fetch(
        `${BASE_URL}/api/laporan-masyarakat/${laporanId}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
              ...
              <ResponsiveTable
                ...
                columns={[
                  ...
                  },
                  {
                    header: "Nama Pelapor",
                    render: (item) => (
                      <div className="max-w-[150px] truncate">{item.nama}</div>
                    ),
                  },
                  {
                    header: "Kategori",
